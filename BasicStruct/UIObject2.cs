...
namespace CulebraTesterAPI.BasicStruct
{
    ...
    /// 新版UI对象
    /// </summary>
    public readonly struct UIObject2 : IUIObject, IEnumerable<UIObject2>
    {
        /// <inheritdoc/>
        ...
        public Task<List<UIObject2>> GetChildrenAsync() => Ctc.UIO2_GetChildren(Oid);
        ...
        /// <inheritdoc/>
        public IEnumerator<UIObject2> GetEnumerator() => GetChildren().GetEnumerator();
        /// <inheritdoc/>
